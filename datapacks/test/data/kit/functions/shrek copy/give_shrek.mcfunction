scoreboard players set @s shrek 1
...
give @s minecraft:carrot_on_a_stick{CustomModelData:0,display:{Lore:['[{"text":"Vomie"}]'],Name:'[{"text":"Switch"}]'},Tags:["Switch"]} 1
give @s minecraft:carrot_on_a_stick{CustomModelData:0,display:{Lore:['[{"text":"Marais"}]'],Name:'[{"text":"Switch"}]'},Tags:["Switch"]} 1
give @s minecraft:carrot_on_a_stick{CustomModelData:0,display:{Lore:['[{"text":"Ane"}]'],Name:'[{"text":"Ane"}]'},Tags:["Ane"]} 1
